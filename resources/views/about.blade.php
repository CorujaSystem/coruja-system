...
<div class="d-flex flex-column align-items-center mt-3" style="font-size: large;">
    ...
    <img src="{{ asset('images/about1.webp')}}" alt="compra de materiais" class="rounded img-fluid" width="400">
